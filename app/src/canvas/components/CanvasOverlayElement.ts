...
import DropdownButton from "./DropdownButton.ts";
import FluidInput from "./FluidInput.ts";
...
export class CanvasOverlayElement extends HTMLElement {
  constructor() {
    ...
    this.fontDropDown.addEventListener("change", (_e) => {
      this.setData("font-family", this.fontDropDown.value.value);
    });
    this.sizeInput = new FluidInput();
    this.sizeInput.addEventListener("change", (_e) => {
